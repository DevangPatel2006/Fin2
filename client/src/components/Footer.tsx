  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <h2 className="max-w-fit mx-auto text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-foreground leading-tight whitespace-nowrap text-center">
        ...
        {/* Bottom glow effect (kept inside container so it doesn't overlap other layout unexpectedly) */}
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 w-80 h-20 bg-primary/10 blur-3xl rounded-full pointer-events-none"
          aria-hidden="true"
        />
      </div>
    </footer>
